...
OUT := testlocallaplaciancl testsinglekernel testeasierkernel
all: $(OUT)
...
testeasierkernel: testeasierkernel.c locallaplaciancl.c single-data-input.h single-expected.h
